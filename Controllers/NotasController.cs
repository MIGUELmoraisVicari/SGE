...
namespace SGE.Controllers
{
    public class NotasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nota,MateriasId,AlunosId,EtapasId")] Notas notas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nota,MateriasId,AlunosId,EtapasId")] Notas notas)
        {
            if (id != notas.Id)
            {
                return NotFound();
