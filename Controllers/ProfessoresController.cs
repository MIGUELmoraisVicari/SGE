...
namespace SGE.Controllers
{
    public class ProfessoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Telefone,Cpf,DtNascimento")] Professores professores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Telefone,Cpf,DtNascimento")] Professores professores)
        {
